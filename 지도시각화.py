...
import folium
from streamlit_folium import st_folium  # Folium과 Streamlit 연결
...
# 이름 매핑 테이블
name_mapping = {
    '수원시 영통구': '영통구', '수원시 장안구': '장안구', '수원시 권선구': '권선구', '수원시 팔달구': '팔달구',
    '성남시 수정구': '수정구', '성남시 중원구': '중원구', '성남시 분당구': '분당구',
    '용인시 처인구': '처인구', '용인시 기흥구': '기흥구', '용인시 수지구': '수지구',
    '고양시 덕양구': '덕양구', '고양시 일산동구': '일산동구', '고양시 일산서구': '일산서구',
    '안산시 단원구': '단원구', '안산시 상록구': '상록구',
    '안양시 동안구': '동안구', '안양시 만안구': '만안구',
    '천안시 서북구': '서북구', '천안시 동남구': '동남구',
    '청주시 상당구': '상당구', '청주시 서원구': '서원구', '청주시 흥덕구': '흥덕구', '청주시 청원구': '청원구',
    '창원시 의창구': '의창구', '창원시 성산구': '성산구', '창원시 마산합포구': '마산합포구',
    '창원시 마산회원구': '마산회원구', '창원시 진해구': '진해구',
    '전주시 완산구': '완산구', '전주시 덕진구': '덕진구',
    '포항시 남구': '포항-남구', '포항시 북구': '포항-북구',
    '광주광역시': ['동구', '서구', '남구', '북구'],
    '울산광역시': ['남구', '중구', '동구', '북구'],
